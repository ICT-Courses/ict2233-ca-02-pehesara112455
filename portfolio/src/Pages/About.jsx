...
import img1 from '../assets/Gemini_Generated_Image_xahlp5xahlp5xahl.png'
...
function About() {
  ...
  return (
    <div className="min-h-[100vh] flex flex-col bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      >
        <h1 className="text-gray-900 dark:text-white font-bold text-6xl">About Me</h1>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 px-6 py-16">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-extrabold text-emerald-700 dark:text-emerald-400 mb-6">
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <span className="font-semibold text-emerald-600 dark:text-emerald-400">React.js</span> and{" "}
            <span className="font-semibold text-emerald-600 dark:text-emerald-400">JavaScript fundamentals</span>, I enjoy building user-friendly and efficient interfaces.
            <br /><br />
            I am currently a student at{" "}
            <span className="italic text-gray-500 dark:text-gray-400">University of Sri Jayewardenepura</span> studying BSc IT (hons). My goal is to create impactful and elegant digital solutions that solve real-world problems.
          </p>
        </div>
      </div>
      ...
      <section
        ref={skillsRef}
        className={`py-16 px-6 md:px-20 transition-all duration-1000 ease-out transform ${
          animateSkills ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <h2 className="text-6xl text-gray-900 dark:text-white font-bold text-center mb-4">My Skills</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            <h3 className="text-2xl font-semibold text-emerald-600 dark:text-emerald-400 mb-4">Technical Skills</h3>
            {technicalSkills.map((skill, index) => renderSkill(skill, index))}
          </div>
          <div>
            <h3 className="text-2xl font-semibold text-emerald-600 dark:text-emerald-400 mb-4">Soft Skills</h3>
