...
import image1 from "../assets/Gemini_Generated_Image_xahlp5xahlp5xahl.png";
...
function Home() {
  ...
  return (
    <div className="min-h-[100vh] flex flex-col bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <div className="w-full flex flex-col px-6 md:px-20 pt-10">
        {/* Image + Text Section */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 py-12">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-snug text-center md:text-left space-y-2">
              <span className="text-black dark:text-white block">I'm</span>
              <span className="text-emerald-700 dark:text-emerald-400 block">Uditha Pehesara,</span>
              <span className="text-black dark:text-white block">Frontend developer and Graphic designer</span>
              <span className="text-emerald-700 dark:text-emerald-400 block">in Sri Lanka</span>
            </h1>
          </div>
        </div>
        ...
        >
          <p className="text-center text-gray-500 dark:text-gray-300 max-w-3xl leading-relaxed">
        ...
        >
          ...
          <Link to="/contact">
            <button className="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-emerald-700 dark:text-emerald-400 font-semibold py-3 px-6 border border-emerald-600 rounded-lg shadow-md transition duration-300 ease-in-out">
              Contact Me
            </button>
          </Link>
          <a
            ...
            className="bg-green-300 dark:bg-gray-700 hover:bg-green-400 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-300 font-semibold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out"
          >
            My Resume
          </a>
        </div>
